    ...
    <div className={`relative overflow-hidden ${className ?? ''}`}>
      ...
      {name && (
        <>
          ...
          />
          <span
            className={`absolute inset-x-0 bottom-0.5 px-0.5 text-center leading-tight text-archive-ivory line-clamp-2 ${TEXT_CLASSES[size]}`}
            style={{ textShadow: '0 0 2px #000, 0 0 4px #000, 1px 1px 2px #000' }}
          >
            {name}
          </span>
        </>
